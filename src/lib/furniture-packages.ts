...
export const STYLES = [
  { id: "modern", label: "Modern", emoji: "🏢", desc: "Clean lines, neutral tones, functional elegance" },
  { id: "scandinavian", label: "Scandinavian", emoji: "🇸🇪", desc: "Light wood, minimalist, hygge comfort" },
  { id: "minimalist", label: "Minimalist", emoji: "◻️", desc: "Less is more — essential pieces only" },
  { id: "italian", label: "Italian Luxury", emoji: "🇮🇹", desc: "Marble, leather, bold statement pieces" },
  { id: "french", label: "French Provincial", emoji: "🇫🇷", desc: "Carved wood, soft fabrics, romantic charm" },
  { id: "farmhouse", label: "Farmhouse", emoji: "🏡", desc: "Rustic wood, warm textures, country living" },
  { id: "contemporary", label: "Contemporary", emoji: "✨", desc: "Trendy, mixed materials, current design" },
  { id: "midcentury", label: "Mid-Century Modern", emoji: "🪑", desc: "Tapered legs, organic shapes, retro cool" },
  { id: "industrial", label: "Industrial", emoji: "🏭", desc: "Metal accents, raw wood, urban loft" },
  { id: "coastal", label: "Coastal", emoji: "🌊", desc: "White & blue, natural textures, beach vibe" },
];

export const HOME_SIZES = [
  { id: "1b1b", label: "1 Bed / 1 Bath Apartment", rooms: "1B/1B", sqft: "~600 sqft" },
  { id: "2b", label: "2 Bedroom Apartment", rooms: "2B", sqft: "~900 sqft" },
  { id: "3b", label: "3 Bed Single Family", rooms: "3B", sqft: "~1,500 sqft" },
  { id: "4b", label: "4 Bed Single Family", rooms: "4B", sqft: "~2,200 sqft" },
  { id: "5b", label: "5+ Bed Estate", rooms: "5B+", sqft: "~3,500+ sqft" },
];
