...
export const PRODUCT_CATEGORIES: ProductCategory[] = [
  ...
  { id: "robotics", label: "Robotic Arms & Automation", emoji: "🦾", htsChapter: "8479", htsNote: "Industrial robots 0% base duty (HTS 8479.50). Subject to Section 301 (25%)", dutyRates: { us: 0, ca: 0, gb: 0, eu: 0, au: 0 }, section301Eligible: true, complianceProfileId: "electronics-fcc", retailMarkupRange: "2–4×", avgRetailMultiplier: 3 },
];
