...
const AGENTS = [
  ...
  { id: "seth", name: "Seth Parker", role: "CTO", avatar: "SP", avatarUrl: "/team/seth-parker.svg", color: "#2563EB",
    ...
    bio: "12 years full-stack engineering, DevOps, cloud infra. Owns the tech stack, deploys, and SEO technical implementation." },
  ...
  { id: "seto", name: "Seto Nakamura", role: "PRO / Editor-in-Chief", avatar: "SN", avatarUrl: "/team/seto-nakamura.svg", color: "#7C3AED",
    skills: ["News Monitoring", "Content Creation", "PR", "Legal", "Industry Analysis"],
    bio: "10 years journalism, PR, international trade media. Writes all blog content, monitors global trade news, builds credibility." },
