...
const AGENTS = [
  ...
  { id: "rachel", name: "Rachel Morales", role: "CMO", avatar: "RM", avatarUrl: "/team/rachel-morales.svg", color: "#D97706",
    skills: ["Growth Hacking", "SEO Mastery", "Content Creation", "Social Media Strategy", "Reddit Community", "AI Citation Strategy", "China Market Localization", "China E-Commerce", "Cross-Border E-Commerce", "WeChat/Private Domain", "Conversion", "Analytics"],
    bio: "14 years digital marketing, B2B/B2C. Full-stack CMO with 14 marketing specializations: growth hacking, SEO, content, social media, Reddit, AI citations, TikTok, Instagram, WeChat OA, private domain, China localization, China e-commerce, and cross-border e-commerce." },
  ...
  { id: "tiffany", name: "Tiffany Wang", role: "CSO", avatar: "TW", avatarUrl: "/team/tiffany-wang.svg", color: "#EC4899",
    skills: ["Deal Strategy", "MEDDPICC", "Discovery Coaching", "Sales Engineering", "Outbound Strategy", "Pipeline Analytics", "Proposal Strategy", "Account Expansion", "Sales Coaching", "Customer Support", "CRM"],
    bio: "8 years customer success, e-commerce ops. Full-stack CSO with 8 sales specializations: deal strategy, discovery coaching, sales engineering, outbound prospecting, pipeline analytics, proposal strategy, account expansion, and sales coaching." },
